...
#define CSI                     std::cout <<"\033["  //two char version of CSI

#define RIS                     std::cout <<"\033c"//; thread_sleep_for(10)   // RIS Reset to Initial State          ESC c
#define EL                      std::cout <<"\033[K"; thread_sleep_for(2)   // cleareol              Erase to end of current line           ^[K
#define EL2                     std::cout <<"\033[2K"; thread_sleep_for(2)   // Esc[2K   Clear entire line   EL2
#define ERASE_TO_END_OF_SCREEN  std::cout <<"\033[J"; thread_sleep_for(2)   // cleareos              Erase to end of screen                 ^[J
#define ED2                     std::cout <<"\033[2J"; thread_sleep_for(2)   // Esc[2J     Clear entire screen     ED2
#define SHOW_CURSOR             std::cout <<"\033[?25h"; thread_sleep_for(2) 
#define HIDE_CURSOR             std::cout <<"\033[?25l"; thread_sleep_for(2) 
#define CUR_POS(l,v)            std::cout <<"\033[" << l << ";" << v << "H"

// CHAR MODES
#define OFF                     std::cout <<"\033[0m"    // modesoff SGR0         Turn off character attributes          ^[[0m
#define NORMAL                  std::cout <<"\033[m"     // modesoff SGR0         Turn off character attributes          ^[[m
#define BOLD                    std::cout <<"\033[1m"    // bold SGR1             Turn bold mode on                      ^[[1m
#define LOWINTENS               std::cout <<"\033[2m"    // lowint SGR2           Turn low intensity mode on             ^[[2m
#define UNDERLINE               std::cout <<"\033[4m"    // underline SGR4        Turn underline mode on                 ^[[4m
#define BLINK                   std::cout <<"\033[5m"    // blink SGR5            Turn blinking mode on                  ^[[5m
#define REVERSE                 std::cout <<"\033[7m"    // reverse SGR7          Turn reverse video on                  ^[[7m

// POSITIONING
#define CLS                     std::cout <<"\033[2J"//; thread_sleep_for(10)        // clearscreen ED2      Esc[2J Clear entire screen
#define HOME                    std::cout <<"\033[H"       // cursorhome            Move cursor to upper left corner       ^[[H

// Foreground Colour
#define BLACK_TEXT              std::cout <<"\033[0;30m"       // Set Text to Black
#define RED_TEXT                std::cout <<"\033[0;31m"       // Set Text to Red
#define GREEN_TEXT              std::cout <<"\033[0;32m"       // Set Text to Green
#define YELLOW_TEXT             std::cout <<"\033[0;33m"       // Set Text to Yellow
#define BLUE_TEXT               std::cout <<"\033[0;34m"       // Set Text to Blue
#define MAGENTA_TEXT            std::cout <<"\033[0;35m"       // Set Text to Magenta
#define CYAN_TEXT               std::cout <<"\033[0;36m"       // Set Text to Cyan
#define WHITE_TEXT              std::cout <<"\033[0;37m"       // Set Text to White
#define BLACK_DIM               std::cout <<"\033[2;30m"       // Set Text to DIM Black
#define RED_DIM                 std::cout <<"\033[2;31m"       // Set Text to DIM Red
#define GREEN_DIM               std::cout <<"\033[2;32m"       // Set Text to DIM Green
#define YELLOW_DIM              std::cout <<"\033[2;33m"       // Set Text to DIM Yellow
#define BLUE_DIM                std::cout <<"\033[2;34m"       // Set Text to DIM Blue
#define MAGENTA_DIM             std::cout <<"\033[2;35m"       // Set Text to DIM Magenta
#define CYAN_DIM                std::cout <<"\033[2;36m"       // Set Text to DIM Cyan
#define WHITE_DIM               std::cout <<"\033[2;37m"       // Set Text to DIM White
#define BLACK_BOLD              std::cout <<"\033[1;30m"       // Set Text to BOLD Black
#define RED_BOLD                std::cout <<"\033[1;31m"       // Set Text to BOLD Red
#define GREEN_BOLD              std::cout <<"\033[1;32m"       // Set Text to BOLD Green
#define YELLOW_BOLD             std::cout <<"\033[1;33m"       // Set Text to BOLD Yellow
#define BLUE_BOLD               std::cout <<"\033[1;34m"       // Set Text to BOLD Blue
#define MAGENTA_BOLD            std::cout <<"\033[1;35m"       // Set Text to BOLD Magenta
#define CYAN_BOLD               std::cout <<"\033[1;36m"       // Set Text to BOLD Cyan
#define WHITE_BOLD              std::cout <<"\033[1;37m"       // Set Text to BOLD White

// Background Colour
#define BLACK_BACK              std::cout <<"\033[40m"       // Set Background to Black
#define RED_BACK                std::cout <<"\033[41m"       // Set Background to Red
#define GREEN_BACK              std::cout <<"\033[42m"       // Set Background to Green
#define YELLOW_BACK             std::cout <<"\033[43m"       // Set Background to Yellow
#define BLUE_BACK               std::cout <<"\033[44m"       // Set Background to Blue
#define MAGENTA_BACK            std::cout <<"\033[45m"       // Set Background to Magenta
#define CYAN_BACK               std::cout <<"\033[46m"       // Set Background to Cyan
#define WHITE_BACK              std::cout <<"\033[47m"       // Set Background to White
